...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        public ContactGenerator()
        {
            ...
            String outputFileName = @"/Users/shaunyan/Documents/GitHub/A00429842_MCDA5510/ConsoleApp1/ConsoleApp1/customers.csv";
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                fileStream.Write(COMMA);
                fileStream.Write(GenerateAddress());
        ...
        public string ReturnRandomLine(string FileName)
        {
            ...
            using (FileStream myFile = new FileStream(@"/Users/shaunyan/Documents/GitHub/A00429842_MCDA5510/ConsoleApp1/ConsoleApp1/" + FileName + ".txt", FileMode.Open, FileAccess.Read))
            {
